...
class ApplicantsControllerTest < ActionController::TestCase
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post :create, :applicant => { :date_applied => @applicant.date_applied, :fname => @applicant.fname, :lname => @applicant.lname }
    end
  ...
  test "should update applicant" do
    put :update, :id => @applicant, :applicant => { :date_applied => @applicant.date_applied, :fname => @applicant.fname, :lname => @applicant.lname }
    assert_redirected_to applicant_path(assigns(:applicant))
  end
